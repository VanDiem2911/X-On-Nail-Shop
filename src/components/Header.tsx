  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-xs">
        ...
        <div className="relative flex items-center justify-between h-24">
          ...
          <div className="absolute left-1/2 -translate-x-1/2">
            <Link
              ...
              className="relative block h-16 w-36 sm:w-44"
            >
              <Image
      ...
      <nav className="hidden lg:block border-t border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ul className="flex items-center justify-center space-x-7 text-[12px] font-bold uppercase tracking-wider text-gray-800 h-11">
            <li>
              <Link
                href="/"
                onClick={handleLinkClick}
                className="hover:text-rose-700 transition-colors py-2"
              >
                Home
              </Link>
            </li>
            ...
            <li className="group relative py-2">
              <Link
                href="/shop"
                onClick={handleLinkClick}
                className="hover:text-rose-700 transition-colors flex items-center gap-1"
              >
                Shop <ChevronDown className="w-3 h-3 group-hover:rotate-180 transition-transform" />
              </Link>

              {/* Mega Menu Dropdown */}
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-[780px] bg-white shadow-2xl rounded-b-xl border border-gray-100 p-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
