...
export function Footer() {
  return (
    <footer className="bg-[#faf8f6] text-gray-800 border-t border-gray-200">
      {/* Main footer grid */}
      ...
      {/* Bottom bar */}
      <div className="border-t border-gray-200 bg-[#f0ede9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between text-[11px] text-gray-400 gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/contact-us" className="hover:text-gray-600 transition-colors">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
